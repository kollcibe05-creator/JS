...
// This allows Mocha to read 'import/export' even if your Node version is older.
...
require('./helpers.js'); // 1. Load the stage manager
const fs = require('fs');
...
describe('UI Instance', () => {
  it('updates the heading text', () => {
    ...
    // 2. Run the function from your source code
...
// Helper Role: It provided the window.fetch polyfill (standard in modern Node, but JSDOM ensures it behaves like a browser fetch).
