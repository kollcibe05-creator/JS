...
// A class describes a group or category of some sort and specifies the characteristics (properties) that all instances of the class (specific poodles) are expected to have. 
